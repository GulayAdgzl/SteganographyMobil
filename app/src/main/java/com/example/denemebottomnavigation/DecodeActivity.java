...
import com.example.denemebottomnavigation.Text.AsyncTaskCallback.TextDecodingCallback;
import com.example.denemebottomnavigation.Text.ImageSteganography;
import com.example.denemebottomnavigation.Text.TextDecoding;
...
public class DecodeActivity extends AppCompatActivity implements TextDecodingCallback {
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setSelectedItemId (R.id.decode);
